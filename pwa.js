...
const cacheName = 'LA6ErinEpperson-2021-03-16 21:09:21.497712'; // unique value, generated each deploy
  ...
  e.waitUntil(
    caches.keys().then((keyList) => {
      ...
      return Promise.all(keyList.map((key) => {
        ...
        if (cacheName.indexOf(key) === -1  && key.substr(0, 'LA6ErinEpperson'.length) === 'LA6ErinEpperson') {
